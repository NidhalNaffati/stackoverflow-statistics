...
!(function (t, e) {
  ...
  function Zt(t, e, i, s) {
    ...
    if (
      h &&
      'object' == typeof h &&
      ((n = h.toString()), '[object HTMLImageElement]' === n || '[object HTMLCanvasElement]' === n)
    )
      return (
        t.save(),
        t.translate(i, s),
  ...
  const li = (t, e) => (t ? t + ht(e) : e),
    hi = (t, e) =>
      U(e) && 'adapters' !== t && (null === Object.getPrototypeOf(e) || e.constructor === Object)
  function ci(t, e, i) {
  ...
  const Si = (t) => 0 === t || 1 === t,
    ...
    Ci = {
      ...
      easeInOutBounce: (t) =>
        t < 0.5 ? 0.5 * Ci.easeInBounce(2 * t) : 0.5 * Ci.easeOutBounce(2 * t - 1) + 0.5
    }
  function Oi(t, e, i, s) {
      ...
      (m = e[t % a]),
        m.skip ||
          ...
          p !== x &&
            ...
            null !== _ &&
              v() &&
              (g.push(Bi({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)),
            (i = t),
            (x = p)))
    return null !== _ && g.push(Bi({ start: _, end: d, loop: u, count: a, style: f })), g
  }
  function Wi(t, e) {
    const i = [],
      s = t.segments
  ...
  function ls(t) {
    return !ge() || ('undefined' != typeof OffscreenCanvas && t instanceof OffscreenCanvas)
      ? Xi
      : rs
  }
  ...
  class Ps {
    ...
    parseObjectData(t, e, i, s) {
      ...
      let h, c, d, u
      for (h = 0, c = s; h < c; ++h)
        (d = h + i), (u = e[d]), (l[h] = { x: n.parse(lt(u, a), d), y: o.parse(lt(u, r), d) })
      return l
    }
    getParsed(t) {
    ...
    applyStack(t, e, i) {
      const s = this.chart,
        n = this._cachedMeta,
        o = e[t.axis]
      return xs({ keys: ms(s, !0), values: e._stacks[t.axis] }, o, n.index, { mode: i })
    }
    ...
    getMinMax(t, e) {
      const i = this._cachedMeta,
        ...
        r = ((t, e, i) => t && !e.hidden && e._stacked && { keys: ms(i, !0), values: null })(
          e,
          i,
          this.chart
        ),
  ...
  class Bs extends Ds {
    ...
    getContext(t) {
      ...
      return (
        this.$context ||
        (this.$context = Ye(this.chart.getContext(), { scale: this, type: 'scale' }))
      )
    }
    _tickSize() {
    ...
    drawTitle() {
      ...
      'bottom' === e || 'center' === e || U(e)
        ? ((l += a.bottom), Y(i.text) && (l += o.lineHeight * (i.text.length - 1)))
        : (l += a.top)
      const {
        titleX: h,
        titleY: c,
      ...
      return !1 !== s || e
        ? (function (t, e, i, s) {
            ...
            for (let a = 0; a < e.length; a++) {
              const r = e[a],
                l = Hs(i[r.id], s)
              null !== l && n.push({ plugin: r, options: js(t.config, r, l, o) })
            }
            return n
          })(t, n, s, e)
        : []
  ...
  function rn(t) {
    return (
      ge() && 'string' == typeof t ? (t = document.getElementById(t)) : t && t.length && (t = t[0]),
      ...
      e &&
        ...
        Q(n, (e) => {
          ...
          if (o in i && i[o].type === r) l = i[o]
            ...
            ;(l = new (Ws.getScale(r))({ id: o, type: r, ctx: this.ctx, chart: this })),
              (i[l.id] = l)
          }
          l.init(n, t)
        }),
  ...
  function wn(t, e, i, s) {
    ...
    return (
      s
        ? ((a = i), (t = Mn((t = (n = t) === (o = e) ? a : n === a ? o : n), i, e)))
        : (t = Mn(t, e, i)),
      t
    )
  }
    ...
    _getStacks(t, e) {
      ...
      for (r = 0; r < o; ++r)
        if (((l = s[r]), l.controller.options.grouped)) {
          ...
          if (
            ((!1 === n || -1 === a.indexOf(l.stack) || (void 0 === n && void 0 === l.stack)) &&
              a.push(l.stack),
            l.index === t)
          )
            break
    ...
    updateElements(t, e, i, s) {
      ...
      for (let r = e; r < e + i; r++) {
        ...
        ;(l.skip = isNaN(u) || isNaN(f)),
          h &&
            ((l.options = this.resolveDataElementOptions(r, e.active ? 'active' : s)),
  ...
  ;(Dn.id = 'doughnut'),
    ...
    (Dn.descriptors = { _scriptable: (t) => 'spacing' !== t, _indexable: (t) => 'spacing' !== t }),
    (Dn.overrides = {
      aspectRatio: 1,
      plugins: {
        legend: {
    ...
    update(t) {
      ...
      let { start: a, count: r } = (function (t, e, i) {
        ...
        if (t._sorted) {
          ...
          d &&
            (n = jt(
              Math.min(re(r, a.axis, h).lo, i ? s : re(e, l, a.getPixelForValue(h)).lo),
              0,
              s - 1
            )),
            (o = u
              ? jt(
                  Math.max(re(r, a.axis, c).hi + 1, i ? 0 : re(e, l, a.getPixelForValue(c)).hi + 1),
                  n,
                  s
                ) - n
              : s - n)
    ...
    updateElements(t, e, i, s) {
      ...
      for (let h = e; h < e + i; ++h) {
        const e = t[h],
          ...
          v = (g[f] =
            n || _ ? a.getBasePixel() : a.getPixelForValue(r ? this.applyStack(a, i, r) : i[f], h))
  ...
  ;(Cn.id = 'line'),
    ...
    (Cn.overrides = { scales: { _index_: { type: 'category' }, _value_: { type: 'linear' } } })
  class On extends Ps {
    constructor(t, e) {
    ...
    a &&
      ...
      e.fullCircles &&
        (function (t, e, i) {
          ...
          let c
          for (
            i && En(t, e, o + yt), t.beginPath(), t.arc(s, n, h, o + yt, o, !0), c = 0;
            c < r;
            ++c
          )
            t.stroke()
  ...
  ;(qn.id = 'line'),
    ...
    (qn.descriptors = { _scriptable: !0, _indexable: (t) => 'borderDash' !== t && 'fill' !== t })
  class Gn extends Ds {
    constructor(t) {
      super(),
        (this.options = void 0),
  ...
  ;(Gn.id = 'point'),
    ...
    (Gn.defaultRoutes = { backgroundColor: 'backgroundColor', borderColor: 'borderColor' })
  class so extends Ds {
    constructor(t) {
      super(),
        (this.options = void 0),
  ...
  ;(so.id = 'bar'),
    ...
    (so.defaultRoutes = { backgroundColor: 'backgroundColor', borderColor: 'borderColor' })
  ...
  class ho {
    ...
    pathSegment(t, e, i) {
      ...
      return (e = e || { start: 0, end: yt }), t.arc(s, n, o, e.end, e.start, !0), !i.bounds
    }
    interpolate(t) {
  ...
  function co(t) {
    return (t.scale || {}).getPointPositionForValue
      ? (function (t) {
          ...
          let l, h, c
          if (
            ((c = 'start' === i ? a : 'end' === i ? r : U(i) ? i.value : e.getBaseValue()),
            s.grid.circular)
          )
            return (
              (h = e.getPointPositionForValue(0, a)),
              new ho({ x: h.x, y: h.y, radius: e.getDistanceFromCenterForValue(c) })
            )
  ...
  function mo(t, e) {
    ...
    return (
      ...
      i.length ? new qn({ points: i, options: { tension: 0 }, _loop: s, _fullLoop: s }) : null
    )
  }
  function xo(t, e, i) {
    let s = t[e].fill
  ...
  function _o(t, e, i, s) {
    ...
    let n = e[t],
      o = i[t]
    return 'angle' === t && ((n = Nt(n)), (o = Nt(o))), { property: t, start: n, end: o }
  }
  function yo(t, e, i, s) {
  ...
  class Do extends Ds {
    ...
    adjustHitBoxes() {
      ...
      if (this.isHorizontal()) {
        ...
        for (const l of e)
          l.col !== o &&
            ((o = l.col), (r = n(i, this.top + t + s, this.bottom - this.columnSizes[o].height))),
            (l.top = r),
            (l.left += this.left + s),
      ...
      this.legendItems.forEach((w, M) => {
        ...
        h.setWidth(this.width),
          _
            ? M > 0 &&
              D + P + u > this.right &&
              ((C = p.y += v), p.line++, (D = p.x = n(a, this.left + u, this.right - i[p.line])))
            : M > 0 &&
              C + v > this.bottom &&
    ...
    drawTitle() {
      ...
      let d,
        ...
        f = this.width
      if (this.isHorizontal())
        (f = Math.max(...this.lineWidths)), (d = this.top + c), (u = n(t.align, u, this.right - f))
      else {
        const e = this.columnSizes.reduce((t, e) => Math.max(t, e.height), 0)
        d =
          c + n(t.align, this.top, this.bottom - e - t.labels.padding - this._computeTitleHeight())
      }
      const g = n(l, u, u + f)
  ...
  ;(Qo.id = 'logarithmic'),
    (Qo.defaults = { ticks: { callback: Os.formatters.logarithmic, major: { enabled: !0 } } })
  class la extends Go {
    constructor(t) {
      super(t),
        (this.xCenter = void 0),
  ...
  function ua(t, e) {
    ...
    return (
      ...
      null === a
        ...
        : (n &&
            (a =
              'week' !== n || (!Tt(o) && !0 !== o) ? i.startOf(a, n) : i.startOf(a, 'isoWeek', o)),
          +a)
    )
  }
  function fa(t, e, i, s) {
  ...
  function xa(t, e, i) {
    ...
    i
      ? (e >= t[r].pos && e <= t[l].pos && ({ lo: r, hi: l } = re(t, 'pos', e)),
        ({ pos: s, time: o } = t[r]),
        ({ pos: n, time: a } = t[l]))
      : (e >= t[r].time && e <= t[l].time && ({ lo: r, hi: l } = re(t, 'time', e)),
        ({ time: s, pos: o } = t[r]),
        ({ time: n, pos: a } = t[l]))
    const h = n - s
