...
<template>
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
    <div class="container-fluid py-4">
      <div class="row">
        <TodayQuestionsCard programming-language="ruby" />
        <WeekQuestionsCard programmingLanguage="ruby" />
        <AnsweredQuestionsCard programmingLanguage="ruby" />
        <ClosedQuestionsCard programmingLanguage="ruby" />
      </div>
      ...
      <div class="row">
        <QuestionsPerDay programming-language="ruby" />
        <DoughnutChartComponent programming-language="ruby" />
      </div>
