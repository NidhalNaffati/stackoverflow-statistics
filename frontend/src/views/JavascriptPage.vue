...
<template>
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
    <div class="container-fluid py-4">
      <div class="row">
        <TodayQuestionsCard programming-language="javascript" />
        <WeekQuestionsCard programmingLanguage="javascript" />
        <AnsweredQuestionsCard programmingLanguage="javascript" />
        <ClosedQuestionsCard programmingLanguage="javascript" />
      </div>
      ...
      <div class="row">
        <QuestionsPerDay programming-language="javascript" />
        <DoughnutChartComponent programming-language="javascript" />
      </div>
